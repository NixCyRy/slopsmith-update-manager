...
def setup(app, context):
    ...
    async def restart_server(body: dict = None):
        ...
        and return — the desktop app handles the actual process restart via
        slopsmithDesktop.plugins.restart(). Without it: re-exec uvicorn
        in-place via os.execv (container path).
        """
